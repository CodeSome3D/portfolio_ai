...
const PORTFOLIO_WORKS = [
  {
    "id": "001",
    "name": "3D Print Miniature - Cyber Paladin",
    "file": "images/3d_print_mini_0004.png",
    "model": [
      "Midjourney"
    ],
  ...
  {
    "id": "002",
    "name": "3D Print Miniature - Tactical Mech",
    "file": "images/3d_print_mini_0015.png",
    "model": [
      "Midjourney"
    ],
    "category": "3D Miniatures",
  ...
  {
    "id": "012",
    "name": "Fox Biker Squad",
    "file": "images/dosome3d_dumb_stoned_foxes-bikers_a02e6cde-38f1-4e16-a07c-8996d66718ec.png",
    "model": [
      "Midjourney"
    ],
    "category": "Creatures & Art",
    "description": "Whimsical illustration of anthropomorphic fox bikers dressed in vintage leather motorcycle jackets."
  },
  {
    "id": "013",
  ...
  {
    "id": "014",
    "name": "Lily of the Valley in Ceramic Vase",
    "file": "images/dosome3d_Lily_of_valley_is_in_the_old_fashioned_ceramic_vase_st_f23f8ca0-2f34-4f91-af6b-916bf060225d.png",
    "model": [
      "Midjourney"
    ],
    "category": "Creatures & Art",
    "description": "Classical still-life painting of delicate lily of the valley blossoms in a rustic ceramic vase."
  },
  {
    "id": "015",
  ...
  {
    "id": "017",
    "name": "Compact Electronic Module",
    "file": "images/dosome3d_ultra_photorealistic_render_of_modern_electronic_devic_f397db54-4593-492c-a116-82e6684d3c7e.png",
    "model": [
      "Midjourney"
    ],
    "category": "Product & Tech",
    "description": "Sleek hardware module with matte dark anodized casing, LED indicators, and connection ports."
  },
  {
    "id": "018",
  ...
  {
    "id": "020",
    "name": "Mr. Fox Gentleman Mascot",
    "file": "images/mrFox_BCard.png",
    "model": [
      "Midjourney"
    ],
    "category": "Creatures & Art",
    "description": "Sophisticated fox character illustration in tailored vintage gentleman attire."
  },
  {
    "id": "021",
